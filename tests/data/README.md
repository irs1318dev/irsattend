...
dataset includes RAPs (Robotics Appearances) from the beginning of the school
...
raps.csv. This database is used by several Pytest fixtures.
The database was created by the test-data.py Marimo notebook.

## test-data.py
A Marimo notebook with code that generated raps.csv and testattend.db.