...
def _(mo):
    ...
    The code in this notebook was used to generate the testattend.db and atts.csv files. The "checkins.csv" contains fictional attendances, where one row represents a student attending one event.
    """
    )
    return
...
@app.cell
def _():
    # attssdf.write_csv("checkins.csv")
    return
