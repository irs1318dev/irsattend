...
def _(mo):
    ...
    The code in this notebook was used to generate the testattend.db and raps.csv files. RAP stans for Robotics Appearance.
    """
    )
    return
...
def _(mo):
    mo.md(
        r"""
    ## Robotics Appearances (RAPs)
    For every student and event, we determine of the student attended that event by randomly sampling a Boolean variable with p(true) equal to the student's attencance probability.
